...
\begin{figure}
	...
	\includegraphics[width=\columnwidth]{green_ui}
	\end{subfigure}
	\begin{subfigure}{0.49\columnwidth}
	\includegraphics[width=\columnwidth]{green_ui2}
	\end{subfigure}
...
\begin{figure*}[t]
	...
	\includegraphics[width=\columnwidth]{annotations_ot.pdf}
	\caption{\footnotesize Task A \hspace*{1.2cm}}
	\label{fig:annotations_ot_a}
	\end{subfigure}
	\begin{subfigure}{0.49\textwidth}
	\includegraphics[width=\columnwidth]{annotations_ot2}
...
\begin{figure*}[t]
	\centering
	\includegraphics[width=\textwidth]{RankBasedSignalWarpingPipeline}
...
\begin{figure*}
	\centering
	\includegraphics[width=0.8\textwidth]{warp_evaldep}
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{warp_correlation_robustness}
...
\begin{thebibliography}{27}
	...
	\bibitem[{Agarwal et~al.(2007)Agarwal, Wills, Cayton, Lanckriet, Kriegman and
		Belongie}]{agarwal2007generalized}
	\bibinfo{author}{Agarwal, S.}, \bibinfo{author}{Wills, J.},
	\bibinfo{author}{Cayton, L.}, \bibinfo{author}{Lanckriet, G.R.},
	\bibinfo{author}{Kriegman, D.J.}, \bibinfo{author}{Belongie, S.J.},
	\bibinfo{year}{2007}.
	\newblock \bibinfo{title}{Generalized non-metric multidimensional scaling}, in:
	\bibinfo{booktitle}{Proceedings of the Artificial Intelligence and Statistics
		Conference}, pp. \bibinfo{pages}{11--18}.
	%Type = Inproceedings
	\bibitem[{Amid and Ukkonen(2015)}]{amid2015multiview}
	\bibinfo{author}{Amid, E.}, \bibinfo{author}{Ukkonen, A.},
	\bibinfo{year}{2015}.
	\newblock \bibinfo{title}{Multiview triplet embedding: Learning attributes in
		multiple maps}, in: \bibinfo{booktitle}{Proceedings of the International
		Conference on Machine Learning}, pp. \bibinfo{pages}{1472--1480}.
	%Type = Inproceedings
	\bibitem[{Andrew et~al.(2013)Andrew, Arora, Bilmes and
		Livescu}]{andrew2013deep}
	\bibinfo{author}{Andrew, G.}, \bibinfo{author}{Arora, R.},
	\bibinfo{author}{Bilmes, J.A.}, \bibinfo{author}{Livescu, K.},
	\bibinfo{year}{2013}.
	\newblock \bibinfo{title}{Deep canonical correlation analysis}, in:
	\bibinfo{booktitle}{Proceedings of the International Conference on Machine
		Learning}, pp. \bibinfo{pages}{1247--1255}.
	%Type = Article
	\bibitem[{Audhkhasi and Narayanan(2013)}]{audhkhasi2013globally}
	\bibinfo{author}{Audhkhasi, K.}, \bibinfo{author}{Narayanan, S.},
	\bibinfo{year}{2013}.
	\newblock \bibinfo{title}{A globally-variant locally-constant model for fusion
		of labels from multiple diverse experts without using reference labels}.
	\newblock \bibinfo{journal}{IEEE transactions on pattern analysis and machine
		intelligence} \bibinfo{volume}{35}, \bibinfo{pages}{769--783}.
	%Type = Article
	\bibitem[{Becker et~al.(2011)Becker, Cand{\`e}s and
		Grant}]{becker2011templates}
	\bibinfo{author}{Becker, S.R.}, \bibinfo{author}{Cand{\`e}s, E.J.},
	\bibinfo{author}{Grant, M.C.}, \bibinfo{year}{2011}.
	\newblock \bibinfo{title}{Templates for convex cone problems with applications
		to sparse signal recovery}.
	\newblock \bibinfo{journal}{Mathematical programming computation}
	\bibinfo{volume}{3}, \bibinfo{pages}{165}.
	%Type = Article
	\bibitem[{Gupta et~al.(2016)Gupta, Audhkhasi, Jacokes, Rozga and
		Narayanan}]{Gupta2016}
	\bibinfo{author}{Gupta, R.}, \bibinfo{author}{Audhkhasi, K.},
	\bibinfo{author}{Jacokes, Z.}, \bibinfo{author}{Rozga, A.},
	\bibinfo{author}{Narayanan, S.}, \bibinfo{year}{2016}.
	\newblock \bibinfo{title}{Modeling multiple time series annotations based on
		ground truth inference and distortion}.
	\newblock \bibinfo{journal}{IEEE Transactions on Affective Computing}
	\bibinfo{volume}{PP}, \bibinfo{pages}{1--1}.
	%Type = Article
	\bibitem[{Hotelling(1936)}]{CCA1936}
	\bibinfo{author}{Hotelling, H.}, \bibinfo{year}{1936}.
	\newblock \bibinfo{title}{Relations between two sets of variates}.
	\newblock \bibinfo{journal}{Biometrika} \bibinfo{volume}{28},
	\bibinfo{pages}{321--377}.
	%Type = Inproceedings
	\bibitem[{Jain et~al.(2016)Jain, Jamieson and Nowak}]{jain2016finite}
	\bibinfo{author}{Jain, L.}, \bibinfo{author}{Jamieson, K.G.},
	\bibinfo{author}{Nowak, R.}, \bibinfo{year}{2016}.
	\newblock \bibinfo{title}{Finite sample prediction and recovery bounds for
		ordinal embedding}, in: \bibinfo{booktitle}{Advances In Neural Information
		Processing Systems}, pp. \bibinfo{pages}{2703--2711}.
	%Type = Article
	\bibitem[{Mariooryad and Busso(2015)}]{Mariooryad2015}
	\bibinfo{author}{Mariooryad, S.}, \bibinfo{author}{Busso, C.},
	\bibinfo{year}{2015}.
	\newblock \bibinfo{title}{{Correcting Time-Continuous Emotional Labels by
			Modeling the Reaction Lag of Evaluators}}.
	\newblock \bibinfo{journal}{IEEE Transactions on Affective Computing}
	\bibinfo{volume}{6}, \bibinfo{pages}{97--108}.
	%Type = Article
	\bibitem[{McKeown et~al.(2012)McKeown, Valstar, Cowie, Pantic and
		Schroder}]{mckeown2012semaine}
	\bibinfo{author}{McKeown, G.}, \bibinfo{author}{Valstar, M.},
	\bibinfo{author}{Cowie, R.}, \bibinfo{author}{Pantic, M.},
	\bibinfo{author}{Schroder, M.}, \bibinfo{year}{2012}.
	\newblock \bibinfo{title}{The semaine database: Annotated multimodal records of
		emotionally colored conversations between a person and a limited agent}.
	\newblock \bibinfo{journal}{IEEE Transactions on Affective Computing}
	\bibinfo{volume}{3}, \bibinfo{pages}{5--17}.
	%Type = Article
	\bibitem[{Metallinou et~al.(2013)Metallinou, Katsamanis and
		Narayanan}]{metallinou2013tracking}
	\bibinfo{author}{Metallinou, A.}, \bibinfo{author}{Katsamanis, A.},
	\bibinfo{author}{Narayanan, S.}, \bibinfo{year}{2013}.
	\newblock \bibinfo{title}{Tracking continuous emotional trends of participants
		during affective dyadic interactions using body language and speech
		information}.
	\newblock \bibinfo{journal}{Image and Vision Computing} \bibinfo{volume}{31},
	\bibinfo{pages}{137--152}.
	%Type = Inproceedings
	\bibitem[{Metallinou and Narayanan(2013)}]{metallinou2013annotation}
	\bibinfo{author}{Metallinou, A.}, \bibinfo{author}{Narayanan, S.},
	\bibinfo{year}{2013}.
	\newblock \bibinfo{title}{Annotation and processing of continuous emotional
		attributes: Challenges and opportunities}, in: \bibinfo{booktitle}{10th IEEE
		International Conference and Workshops on Automatic Face and Gesture
		Recognition}, \bibinfo{organization}{IEEE}. pp. \bibinfo{pages}{1--8}.
	%Type = Article
	\bibitem[{M{\"u}ller(2007)}]{DTW2007}
	\bibinfo{author}{M{\"u}ller, M.}, \bibinfo{year}{2007}.
	\newblock \bibinfo{title}{Dynamic time warping}.
	\newblock \bibinfo{journal}{Information retrieval for music and motion} ,
	\bibinfo{pages}{69--84}.
	%Type = Article
	\bibitem[{Nicolaou et~al.(2014)Nicolaou, Pavlovic and
		Pantic}]{nicolaou2014dynamic}
	\bibinfo{author}{Nicolaou, M.A.}, \bibinfo{author}{Pavlovic, V.},
	\bibinfo{author}{Pantic, M.}, \bibinfo{year}{2014}.
	\newblock \bibinfo{title}{Dynamic probabilistic cca for analysis of affective
		behavior and fusion of continuous annotations}.
	\newblock \bibinfo{journal}{IEEE transactions on pattern analysis and machine
		intelligence} \bibinfo{volume}{36}, \bibinfo{pages}{1299--1311}.
	%Type = Inproceedings
	\bibitem[{Nicolaou et~al.(2013)Nicolaou, Zafeiriou and
		Pantic}]{nicolaou2013correlated}
	\bibinfo{author}{Nicolaou, M.A.}, \bibinfo{author}{Zafeiriou, S.},
	\bibinfo{author}{Pantic, M.}, \bibinfo{year}{2013}.
	\newblock \bibinfo{title}{Correlated-spaces regression for learning continuous
		emotion dimensions}, in: \bibinfo{booktitle}{Proceedings of the 21st ACM
		international conference on Multimedia}, \bibinfo{organization}{ACM}. pp.
	\bibinfo{pages}{773--776}.
	%Type = Article
	\bibitem[{Ringeval et~al.(2015)Ringeval, Eyben, Kroupi, Yuce, Thiran, Ebrahimi,
		Lalanne and Schuller}]{Ringeval2015}
	\bibinfo{author}{Ringeval, F.}, \bibinfo{author}{Eyben, F.},
	\bibinfo{author}{Kroupi, E.}, \bibinfo{author}{Yuce, A.},
	\bibinfo{author}{Thiran, J.P.}, \bibinfo{author}{Ebrahimi, T.},
	\bibinfo{author}{Lalanne, D.}, \bibinfo{author}{Schuller, B.},
	\bibinfo{year}{2015}.
	\newblock \bibinfo{title}{{Prediction of ashynchronous dimensional emotion
			ratings from audiovisual and physiological data}}.
	\newblock \bibinfo{journal}{Pattern Recognition Letters} \bibinfo{volume}{66},
	\bibinfo{pages}{22--30}.
	%Type = Inproceedings
	\bibitem[{Ringeval et~al.(2013)Ringeval, Sonderegger, Sauer and
		Lalanne}]{ringeval2013introducing}
	\bibinfo{author}{Ringeval, F.}, \bibinfo{author}{Sonderegger, A.},
	\bibinfo{author}{Sauer, J.}, \bibinfo{author}{Lalanne, D.},
	\bibinfo{year}{2013}.
	\newblock \bibinfo{title}{Introducing the recola multimodal corpus of remote
		collaborative and affective interactions}, in: \bibinfo{booktitle}{10th IEEE
		International Conference and Workshops on Automatic Face and Gesture
		Recognition}, \bibinfo{organization}{IEEE}. pp. \bibinfo{pages}{1--8}.
	%Type = Article
	\bibitem[{Rudin et~al.(1992)Rudin, Osher and Fatemi}]{rudin1992nonlinear}
	\bibinfo{author}{Rudin, L.I.}, \bibinfo{author}{Osher, S.},
	\bibinfo{author}{Fatemi, E.}, \bibinfo{year}{1992}.
	\newblock \bibinfo{title}{Nonlinear total variation based noise removal
		algorithms}.
	\newblock \bibinfo{journal}{Physica D: Nonlinear Phenomena}
	\bibinfo{volume}{60}, \bibinfo{pages}{259--268}.
	%Type = Inproceedings
	\bibitem[{Tamuz et~al.(2011)Tamuz, Liu, Shamir, Kalai and
		Belongie}]{tamuz2011adaptively}
	\bibinfo{author}{Tamuz, O.}, \bibinfo{author}{Liu, C.},
	\bibinfo{author}{Shamir, O.}, \bibinfo{author}{Kalai, A.},
	\bibinfo{author}{Belongie, S.J.}, \bibinfo{year}{2011}.
	\newblock \bibinfo{title}{Adaptively learning the crowd kernel}, in:
	\bibinfo{booktitle}{Proceedings of the 28th International Conference on
		Machine Learning (ICML-11)}, \bibinfo{publisher}{ACM}. pp.
	\bibinfo{pages}{673--680}.
	%Type = Inproceedings
	\bibitem[{Trigeorgis et~al.(2016)Trigeorgis, Nicolaou, Zafeiriou and
		Schuller}]{trigeorgis2016deep}
	\bibinfo{author}{Trigeorgis, G.}, \bibinfo{author}{Nicolaou, M.A.},
	\bibinfo{author}{Zafeiriou, S.}, \bibinfo{author}{Schuller, B.W.},
	\bibinfo{year}{2016}.
	\newblock \bibinfo{title}{Deep canonical time warping}, in:
	\bibinfo{booktitle}{Proceedings of the IEEE Conference on Computer Vision and
		Pattern Recognition}, pp. \bibinfo{pages}{5110--5118}.
	%Type = Inproceedings
	\bibitem[{Valstar et~al.(2016)Valstar, Gratch, Schuller, Ringeval, Lalanne,
		Torres~Torres, Scherer, Stratou, Cowie and Pantic}]{valstar2016avec}
	\bibinfo{author}{Valstar, M.}, \bibinfo{author}{Gratch, J.},
	\bibinfo{author}{Schuller, B.}, \bibinfo{author}{Ringeval, F.},
	\bibinfo{author}{Lalanne, D.}, \bibinfo{author}{Torres~Torres, M.},
	\bibinfo{author}{Scherer, S.}, \bibinfo{author}{Stratou, G.},
	\bibinfo{author}{Cowie, R.}, \bibinfo{author}{Pantic, M.},
	\bibinfo{year}{2016}.
	\newblock \bibinfo{title}{Avec 2016: Depression, mood, and emotion recognition
		workshop and challenge}, in: \bibinfo{booktitle}{Proceedings of the 6th
		International Workshop on Audio/Visual Emotion Challenge},
	\bibinfo{organization}{ACM}. pp. \bibinfo{pages}{3--10}.
	%Type = Inproceedings
	\bibitem[{Van Der~Maaten and Weinberger(2012)}]{van2012stochastic}
	\bibinfo{author}{Van Der~Maaten, L.}, \bibinfo{author}{Weinberger, K.},
	\bibinfo{year}{2012}.
	\newblock \bibinfo{title}{Stochastic triplet embedding}, in:
	\bibinfo{booktitle}{IEEE International Workshop on Machine Learning for
		Signal Processing (MLSP)}, \bibinfo{organization}{IEEE}. pp.
	\bibinfo{pages}{1--6}.
	%Type = Inproceedings
	\bibitem[{Yannakakis and Hallam(2011)}]{Yannakakis2011}
	\bibinfo{author}{Yannakakis, G.N.}, \bibinfo{author}{Hallam, J.},
	\bibinfo{year}{2011}.
	\newblock \bibinfo{title}{Ranking vs. preference: A comparative study of
		self-reporting}, in: \bibinfo{booktitle}{Affective Computing and Intelligent
		Interaction: 4th International Conference}, \bibinfo{publisher}{Springer}.
	pp. \bibinfo{pages}{437--446}.
	%Type = Article
	\bibitem[{Yannakakis and Mart{\'\i}nez(2015)}]{yannakakis2015ratings}
	\bibinfo{author}{Yannakakis, G.N.}, \bibinfo{author}{Mart{\'\i}nez, H.P.},
	\bibinfo{year}{2015}.
	\newblock \bibinfo{title}{Ratings are overrated!}
	\newblock \bibinfo{journal}{Frontiers in ICT} \bibinfo{volume}{2},
	\bibinfo{pages}{13}.
	%Type = Inproceedings
	\bibitem[{Zhou and Torre(2009)}]{CTW2009}
	\bibinfo{author}{Zhou, F.}, \bibinfo{author}{Torre, F.}, \bibinfo{year}{2009}.
	\newblock \bibinfo{title}{Canonical time warping for alignment of human
		behavior}, in: \bibinfo{booktitle}{Advances in neural information processing
		systems}, pp. \bibinfo{pages}{2286--2294}.
	%Type = Article
	\bibitem[{Zhou and De~la Torre(2016)}]{Zhou2016}
	\bibinfo{author}{Zhou, F.}, \bibinfo{author}{De~la Torre, F.},
	\bibinfo{year}{2016}.
	\newblock \bibinfo{title}{Generalized canonical time warping}.
	\newblock \bibinfo{journal}{IEEE transactions on pattern analysis and machine
		intelligence} \bibinfo{volume}{38}, \bibinfo{pages}{279--294}.
	%Type = Article
	\bibitem[{Zhu et~al.(2015)Zhu, Dunkley, Behar, Clifton and
		Clifford}]{zhu2015fusing}
	\bibinfo{author}{Zhu, T.}, \bibinfo{author}{Dunkley, N.},
	\bibinfo{author}{Behar, J.}, \bibinfo{author}{Clifton, D.A.},
	\bibinfo{author}{Clifford, G.D.}, \bibinfo{year}{2015}.
	\newblock \bibinfo{title}{Fusing continuous-valued medical labels using a
		bayesian model}.
	\newblock \bibinfo{journal}{Annals of biomedical engineering}
	\bibinfo{volume}{43}, \bibinfo{pages}{2892--2902}.
